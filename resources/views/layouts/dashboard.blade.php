            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ url('/dashboard') }}">                                            
                        <!-- Logo text -->
                        <span>                          
						<i class="mdi mdi-square-inc-cash"></i> SISTEM-SPP                             
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ url('assets/images/code_live.png') }}" alt="user" class="rounded-circle" width="31"></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        <!-- ============================================================== -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="{{ url('assets/images/code_live.png') }}" alt="users" class="rounded-circle" width="40" /></div>
					  ...
					  @if(auth()->user()->level == 'admin')
						...
						<li class="sidebar-item">
				         ...
				         @endif  
                            ...
                            @if(auth()->user()->level == 'admin')
						<li class="sidebar-item">
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('dashboard/notif') }}" aria-expanded="false">
								<i class="mdi mdi-file-document"></i>
