                  ...
                  <div class="card-body">
                       <div class="card-title">{{ __('Edit Kelas') }}</div>
                        ...
                        <form method="post" action="{{ url('/dashboard/data-kelas', $edit->id) }}">
                           ...
                           <div class="form-group">
                              <label>Jenjang</label>
                              <input type="text" class="form-control @error('keahlian') is-invalid @enderror" name="jenjang" value="{{ $edit->jenjang }}">
                              <span class="text-danger">@error('jenjang') {{ $message }} @enderror</span>
                           </div>
